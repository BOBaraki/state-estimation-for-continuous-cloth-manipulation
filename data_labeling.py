...
PATH = "/home/tzortzis/real_data/Downloads/rectangular_brown_stripes/two_hand_side/"
EXT = "*.csv"
img_EXT = "*.png"
fn = 'rect_brown_stripes_two_hand_side_'
...
def stateidentification(filename, flat, semi, folded):
    if filename == fn+'100001' or filename == fn+'100120':
        flat = True
        semi = False
        folded = False
        # lifted = False
    elif name == fn+'100036' or name == fn+'200045':
        flat = False
        semi = True
        folded = False
        # lifted = False
    ...
    #     semi_crampled = True
    #     lifted = False
    elif name == fn+'100095' or name == fn+'200105':
        flat = False
        semi = False
        folded = True
        # lifted = True
